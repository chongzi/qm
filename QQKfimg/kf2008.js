...
if(kfguin)
{
  rightDivHtml = '<div id="rightDiv" style="position:absolute; top:210px; right:1px;">';
...
function kf_getPopupDivHtml(kfguin,reference,companyname,welcomeword)
{
    ...
    temp += '<a  href="http://wpa.qq.com/msgrd?v=3&uin='+kfguin+'" style="float:right;background-image: url('+urlroot+'btn_2.gif);margin: 0px;padding: 0px;border:0px;height: 21px;width: 69px;"></a></div>';
...
{	
  ...
  temp += '<div style="clear:both;"><a href="http://wpa.qq.com/msgrd?v=3&uin='+kfguin+'" style="width:69px; height:21px; background:url('+urlroot+'btn_2.gif); margin:0 0 0 2px; display:block;"></a></div></div>';
...
{//http://wpa.qq.com/msgrd?v=3&uin=1224664320&amp;Site=sztbg.com&amp;Menu=yes
	window.open('http://wpa.qq.com/msgrd?v=3&uin='+kfguin+'', '_blank', 'height=544, width=644,toolbar=no,scrollbars=no,menubar=no,status=no');
	if(flag==1)
	{
		kf_hidekfpopup();
	}
...
{ 
	...
	var now = new Date();
    img.src = "http://wpa.qq.com/msgrd?v=3&uin=" + kfguin + "&ext=0" + "&time=" + now.getTime() + "ip=172.23.30.15&";
