...
<div id="cl-wrapper" class="login-container">
	<div class="middle-login">
						...
						<h4 class="title">登 陆</h4>
							...
							<div class="form-group">
								<div class="col-sm-12">
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-lock"></i></span>
										<input type="text" placeholder="验证码" name="code" class="form-control" style="width:50%">
								      	<img src="<?php echo U('verify');?>" style="width:50%; height:39px; overflow:hidden;" alt="" onclick="cahngeck()" id="code_img" />
									</div>
								</div>
							</div>							
		...
		<div class="text-center out-links"><a href="#"><?php echo ($webtitle); ?> &copy; <?php echo ($webcopy); ?></a></div>
	</div> 
</div>
...
<script>
    function  cahngeck(){
	    ...
	    var srcpath = "<?php echo U('verify');?>"+'?'+random;
	    $("#code_img").attr('src',srcpath);
	}
</script>
</body>
</html>