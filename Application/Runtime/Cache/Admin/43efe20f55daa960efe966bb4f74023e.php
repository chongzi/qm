					...
					<div class="tab-container">
						<form action="<?php echo U();?>" class="form-horizontal"  method="post">
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="username" class="form-control" value="<?php echo ((isset($info["username"]) && ($info["username"] !== ""))?($info["username"]):''); ?>" placeholder="用户名"/>
								</div>
							</div>
							<div class="form-group">
...
<script type="text/javascript" src="/Public/Admin/js/myAjax.js"></script>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			highlight_subnav('<?php echo U('AdminUser/add');?>');
		});
	</script>
